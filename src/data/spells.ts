...
export const SPELLS: SpellData[] = [
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You conjure a spirit from the Upper Planes, which manifests as a pillar of light in a 10-foot-radius, 40-foot-high Cylinder [Area of Effect] centered on a point within range. For each creature you can see in the Cylinder [Area of Effect], choose which of these lights shines on it: **Healing Light:** The target regains Hit Points equal to 4d12 plus your spellcasting ability modifier. **Searing Light:** The target makes a Dexterity saving throw, taking 6d12 Radiant damage on a failed save or half as much damage on a successful one. Until the spell ends, Bright Light fills the Cylinder [Area of Effect], and when you move on your turn, you can also move the Cylinder [Area of Effect] up to 30 feet. Whenever the Cylinder [Area of Effect] moves into the space of a creature you can see and whenever a creature you can see enters the Cylinder [Area of Effect] or ends its turn there, you can bathe it in one of the lights. A creature can be affected by this spell only once per turn. **Using a Higher-Level Spell Slot:** The healing and damage increase by 6d12 for each spell slot level above 7."
  },
  {
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You do one of the following: **Create Water:** You create up to 10 gallons of clean water within range in an open container. Alternatively, the water falls as rain in a 30-foot Cube [Area of Effect] within range, extinguishing exposed flames there. **Destroy Water:** You destroy up to 10 gallons of water in an open container within range. Alternatively, you destroy fog in a 30-foot Cube [Area of Effect] within range. **Using a Higher-Level Spell Slot:** You create or destroy 10 additional gallons of water, or the size of the Cube [Area of Effect] increases by 5 feet, for each spell slot level above 1."
  },
  {
    "name": "Create Undead",
    "level": 6,
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You create a 10-foot-radius, 20-foot-tall Cylinder [Area of Effect] of magical energy centered on a point on the ground that you can see within range. Glowing runes appear wherever the Cylinder [Area of Effect] intersects with the floor or other surface. Choose one or more of the following types of creatures: Celestials, Elementals, Fey, Fiends, or Undead. The circle affects a creature of the chosen type in the following ways: The creature can't willingly enter the Cylinder [Area of Effect] by nonmagical means. If the creature tries to use teleportation or interplanar travel to do so, it must first succeed on a Charisma saving throw. The creature has Disadvantage on attack rolls against targets within the Cylinder [Area of Effect]. Targets within the Cylinder [Area of Effect] can't be possessed by or gain the Charmed or Frightened condition from the creature. Each time you cast this spell, you can cause its magic to operate in the reverse direction, preventing a creature of the specified type from leaving the Cylinder [Area of Effect] and protecting targets outside it. **Using a Higher-Level Spell Slot:** The duration increases by 1 hour for each spell slot level above 3."
  },
  {
    "name": "Magic Jar",
    "level": 6,
