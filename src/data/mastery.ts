...
export const MASTERY_PROPERTIES: MasteryProperty[] = [
  {
    "name": "Cleave",
  ...
  {
    "name": "Topple",
    "description": "If you hit a creature with this weapon, you can force the creature to make a Constitution saving throw (8 plus the ability modifier used to make the attack roll and your Proficiency). On a failed save, the creature has the Prone condition."
  },
  {
    "name": "Vex",
